document.getElementById("calcularBtn").addEventListener("click", function() {
    ...
    // Exibindo a diferença diretamente na caixa de resultado em euros
    document.getElementById("resultado").innerHTML = `A diferença entre os preços é € ${diferenca.toFixed(2)}.`;
